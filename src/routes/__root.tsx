...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Frankfurt-based entrepreneur and system architect building AI-supported business operating systems for multi-company operations — from quote to e-invoice, from site to financial control." },
      { name: "twitter:description", content: "Frankfurt-based entrepreneur and system architect building AI-supported business operating systems for multi-company operations — from quote to e-invoice, from site to financial control." },
