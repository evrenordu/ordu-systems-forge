    ...
    >
      ...
      >
        <img
          ...
          className="h-full w-full translate-y-[3%] scale-[1.1] object-cover object-[35%_38%] sm:translate-y-[2%] sm:scale-[1.06] sm:object-[45%_40%] md:translate-y-0 md:scale-[1.04] md:object-[60%_center] lg:object-[58%_center]"
          fetchPriority="high"
          decoding="async"
          loading="eager"
        />
